					...
					<?php if ( have_posts() ) : ?>
						...
						<div class="lsx-business-directory-wrapper">
							<div class="row">
								...
								<div class="<?php print esc_attr( $filter_classes ); ?>">
								...
								<div class="<?php print esc_attr( $results_classes ); ?>">

									<div class="business-listings">

										<div class="<?php print esc_attr( $search_classes ); ?>">
										...
										<div class="<?php print esc_attr( $layout_classes ); ?>">
										<?php
										while ( have_posts() ) :
											the_post();
										...
										<div class="<?php print esc_attr( $pagination_classes ); ?>"><?php echo do_shortcode( '[facetwp pager="true"]' ); ?></div>
									</div>
								</div>
							</div>
						</div>
